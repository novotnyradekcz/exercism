...
(defun row (board row-num)
  (make-array '(3) :initial-contents (list (aref board row-num 0) (aref board row-num 1) (aref board row-num 2)))
  )

(defun column (board col-num)
  (make-array '(3) :initial-contents (list (aref board 0 col-num) (aref board 1 col-num) (aref board 2 col-num)))
  )
